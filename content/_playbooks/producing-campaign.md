...
### 2. Media Buying & Set-up

The media plan developed during planning will need to be executed with campaign set-up. Campaign set-up involves hiring the media vendors on your plan (signing contracts, agreeing to terms & conditions) and the uploading of your campaign’s media placement and creative details into each media vendor’s systems (including how long each placement will run, how much media activity is being purchased, agreed-to pricing of each placement, and total budget).
